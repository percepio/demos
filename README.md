...
* [STMicroelectronics B-L475E-IOT01A1 using IAR Embedded Workbench](https://github.com/percepio/demos/tree/main/STM32CubeDemos-B-L475E-IOT01A/Projects/EWARM)
* [STMicroelectronics B-L475E-IOT01A1 using STM32CubeIDE](https://github.com/percepio/demos/tree/main/STM32CubeDemos-B-L475E-IOT01A/Projects/STM32CubeIDE)
* [Microchip PIC32CK-SG01 with MPLAB X IDE](https://github.com/percepio/demos/tree/main/PIC32CK-SG01)
...
Tracealyzer is an advanced visualization tool for embedded software traces, generated by the [TraceRecorder](https://github.com/percepio/TraceRecorderSource) tracing library. Tracealyzer also support other trace formats, but most RTOS integrations rely on TraceRecorder.
...
* In Percepio Detect, TraceRecorder snapshots are saved by the device software using the DFM library and transmitted to the host computer as part of an "alert", for example using the serial port or ITM/SWO.
