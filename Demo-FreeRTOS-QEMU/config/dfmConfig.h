...
/* Send diagnostics and the serial cloud port through the MPS2 UART. */
#include <stdio.h>
#define DFM_CFG_PRINT(msg) ((void)printf("%s", (msg)))
...
*/
#define DFM_CFG_AFTER_ALERT_SEND(pxAlert) ((void)(pxAlert))
...
/* Attach the current RingBuffer trace to generated DFM alerts. */
#define DFM_CFG_USE_TRACE_RECORDER 1
