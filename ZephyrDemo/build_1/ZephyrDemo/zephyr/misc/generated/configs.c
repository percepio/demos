...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_USE_CORTEX_M_DWT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_RECORDER_RTOS_ZEPHYR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_USE_SYSCALL_EXTENSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_START_MODE_START, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_RECORDER_BUFFER_ALLOCATION_STATIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_STREAM_PORT_RINGBUFFER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_STREAM_PORT_RINGBUFFER_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_STREAM_PORT_RINGBUFFER_MODE_OVERWRITE_WHEN_FULL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_ENTRY_TABLE_SLOTS, 40);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_ENTRY_SYMBOL_MAX_LENGTH, 28);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_CTRL_TASK_PRIORITY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_CTRL_TASK_DELAY, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_CTRL_TASK_STACK_SIZE, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_MAX_ISR_NESTING, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_ISR_TAILCHAINING_THRESHOLD, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_ENABLE_STACK_MONITOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_STACK_MONITOR_MAX_TASKS, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_STACK_MONITOR_MAX_REPORTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_ENABLE_TASK_MONITOR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_TASK_MONITOR_MAX_TASKS, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_RECORDER_DATA_INIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRC_CFG_USE_TRACE_ASSERT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_FIRMWARE_VERSION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_PRODUCTID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_ENABLE_DEBUG_PRINT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_TASK_MONITOR_MAX_TASKS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_CLOUDPORT_SERIAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_STORAGEPORT_NONE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_MAX_PAYLOAD_CHUNK_SIZE, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_DEVICE_NAME_MAX_LEN, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_MAX_PAYLOADS, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_MAX_SYMPTOMS, 8);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_FIRMWARE_VERSION_MAX_LEN, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_DESCRIPTION_MAX_LEN, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_DELAY_BETWEEN_SEND, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_SELECTED_STORAGE_STRATEGY_IGNORE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_SELECTED_CLOUD_STRATEGY_ONLINE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_SELECTED_SESSIONID_STRATEGY_ONALERT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_ENABLE_COREDUMPS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_COREDUMP_SEND, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_STACKDUMP_SIZE, 300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_MAX_COREDUMP_SIZE, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_DFM_CFG_ADD_TRACE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DEBUG_COREDUMP_BACKEND_OTHER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PERCEPIO_TRACERECORDER, 1);
